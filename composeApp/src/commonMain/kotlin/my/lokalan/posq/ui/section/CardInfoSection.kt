...
import my.posq.shared.Aqua
import my.posq.shared.Green
...
import my.lokalan.posq.ui.component.TitleTextIcon
    ...
    Card(
        ...
        ConstraintLayout(
            ...
            Column(modifier = Modifier.constrainAs(valueRef) {
                ...
                Text(
                    text = value,
                    style = PosqTypography.titleLarge.copy(color = TextOnColor),
                )
            }
